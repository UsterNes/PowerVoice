...
void CHyperLink::SetItalic(BOOL bItalic)
{
	m_bItalic=bItalic;
	Invalidate();
}

void CHyperLink::SetToolTip(const CString &ToolTip)
{
	m_ToolTip.UpdateTipText(ToolTip, this, TOOLTIP_ID);
}
